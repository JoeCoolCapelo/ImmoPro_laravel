<section class="space-y-6">
    <header>
        <h2 class="text-lg font-black text-rose-600 dark:text-rose-500 uppercase tracking-tight">
    ...
    <x-modal name="confirm-user-deletion" :show="$errors->userDeletion->isNotEmpty()" focusable>
        <form method="post" action="{{ route('profile.destroy') }}" class="p-6">
            ...
            <p class="mt-1 text-sm text-slate-600 dark:text-slate-400 font-medium">
                {{ __('Une fois votre compte supprimé, toutes ses ressources et données seront définitivement effacées. Veuillez entrer votre mot de passe pour confirmer la suppression.') }}
            </p>
